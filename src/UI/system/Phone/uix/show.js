    ...
    <Show title={<Title />} {...props} >
      <SimpleShowLayout {...props}>
        ...
        <DependentField resolve={showIfNotEmptyRel('typeId')} source="typeId" >
          <ReferenceField label="resources.Phone.fields.type" source="typeId" reference="system/PhoneType" allowEmpty linkType="show" >
            <TextField source="name" allowEmpty />
          </ReferenceField>
        </DependentField>

        <DependentField resolve={showIfNotEmptyRel('personId')} source="personId" >
          <ReferenceField label="resources.Phone.fields.person" source="personId" reference="system/Person" allowEmpty linkType="show" >
