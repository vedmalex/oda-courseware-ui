  ...
  render() {
    ...
    return (
      <SimpleForm {...props} >
        ...
        <Label text="Groups" />
        <ReferenceArrayInput sortable={false} label="" source="groupsIds" reference="StudentsGroup" allowEmpty >
          <SelectArrayInput options={{ fullWidth: true }} optionText="name" optionValue="id" />
        </ReferenceArrayInput>

        <Label text="Teacher" />
        <ReferenceInput sortable={false} label="" source="teacherId" reference="Teacher" allowEmpty  >
